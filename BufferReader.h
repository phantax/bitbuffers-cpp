...
public:
    ...
    // TODO: Add description
    std::string toBitString(bool split = false, BC from = -1, BC len = -1) const;

    // TODO: Add description
    std::string toHexString(bool split = false, BC from = -1, BC len = -1) const;

    // TODO: Add description
    std::string toBase64String() const;

    // TODO: Add description
    std::string toRawString(size_t cols = 16, BC from = -1, BC len = -1) const;

    // TODO: Add description
    std::string toCString(size_t cols = 16, BC from = -1, BC len = -1) const;
